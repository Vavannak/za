...
const mozilla = [
 ...
 var cn = control_header[Math.floor(Math.floor(Math.random() * control_header.length))];
 ...
 var cou = country[Math.floor(Math.floor(Math.random() * country.length))];
