//Method By STEVEN•STORE🕊🪽 
 ...
 if (process.argv.length < 7){console.log(`Usage: node tls-x.js target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
const tips1 =[
 "Thanks For Buy Scripts STEVEN•STORE〽 @stevenstoree",
