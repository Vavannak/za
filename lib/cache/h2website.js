...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Leaked by t.me/stevenstoree \nUsage: \nnode h2website.js host time req thread proxy file\nExample: node h2website https://google.com/ 60 64 10 proxy.txt `); process.exit();}
...
if (cluster.isMaster) {
    console.clear();
    console.log(`t.me/stevenstoree`.bgRed), console.log(`[!] STEVEN HTTP/2`);
    console.log(`--------------------------------------------`.gray);
