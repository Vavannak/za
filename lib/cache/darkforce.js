...
module.exports = function Cloudflare() {
 ...
 if (process.argv.length < 8){console.log(`Method DDoS By STEVEN•STORE🕊🪽\n Usage: node darkforce.js target time thread proxy.txt rate uam/captha`); process.exit();}
 const headers = {};
