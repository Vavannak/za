//Method By STEVEN•STORE🕊🪽 
 ...
 const cplist = [ // Captcha Solve by stevenstoree 10-04-2023
 ...
 class NetSocket {
  ...
  HTTP(options, callback) {
     const parsedAddr = options.address.split(":"); // Socket Connection Fixed by stevenstoree 27-03-2023
     ...
     connection.on("data", chunk => { //HTTP Version Fixed by stevenstoree 08-04-2023
