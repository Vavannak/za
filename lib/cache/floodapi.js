...
if (process.argv.length < 7) {
    ...
    ${'方法：'.bold.underline}
        ...
        ${`node flood.js ${'['.red.bold}目标${']'.red.bold} ${'['.red.bold}时间${']'.red.bold} ${'['.red.bold}线程${']'.red.bold} ${'['.red.bold}速率${']'.red.bold} ${'['.red.bold}代理${']'.red.bold} ${'('.red.bold}选项${')'.red.bold}`.italic}
        ${'node flood.js https://google.com/ 300 5 50 proxy.txt'.italic}
